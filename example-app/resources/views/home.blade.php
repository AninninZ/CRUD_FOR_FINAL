	...
	<div class="table-responsive">
		<div class="table-wrapper">
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
                    <?php foreach($user_data as $index => $data) { ?>
					<tr>
						<td>{{$data -> user_id}}</td>
...
<script>
    $(document).ready(function () {
        $('.edit').click(function () {
            ...
            var address = $(this).closest('tr').find('td:nth-child(4)').text();
            var phone = $(this).closest('tr').find('td:nth-child(5)').text();
...
<script>
    $(document).ready(function () {
        $('.delete').click(function () {
            var id = $(this).closest('tr').find('td:first-child').text();
            $('#deleteForm').attr('action', '/crud/' + id);
        });
    });
</script>
